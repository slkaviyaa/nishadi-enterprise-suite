...
export default function BillSettings() {
  ...
  // 🚀 Full Customizable State with Dynamic Sizes
  const [form, setForm] = useState({
    ...
    // 🟢 Sizes (New dynamic sizing variables)
    logo_size: 60,
    qr_size: 80,
    font_size_greeting: 14,
    font_size_header: 20,
    font_size_contact: 12,
    font_size_body: 12,
    font_size_total: 15,
    font_size_footer: 12,
    font_size_watermark: 9,
  ...
  return (
    <PageTemplate
      ...
      subtitle="Total control over your receipt layout, sizes, and elements"
      actions={actions}
    >
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-full">
        
        {/* COLUMN 1: Text & Hardware */}
        ...
        {/* COLUMN 2: Sizes, Margins & Toggles */}
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 flex flex-col gap-4 overflow-y-auto max-h-[750px] custom-scrollbar">
          
          {/* 🟢 NEW SIZES SECTION */}
          <h3 className="font-bold text-gray-800 dark:text-white border-b pb-2 sticky top-0 bg-white dark:bg-gray-800 z-10">Element Sizes (px)</h3>
          <div className="grid grid-cols-3 gap-2">
            <div><label className="text-[10px] text-gray-500 block">Logo Size</label><input type="number" className="w-full border dark:border-gray-600 bg-gray-50 dark:bg-gray-700 rounded p-1.5 text-xs" value={form.logo_size || 60} onChange={e => handleChange('logo_size', Number(e.target.value))} /></div>
            <div><label className="text-[10px] text-gray-500 block">Header Font</label><input type="number" className="w-full border dark:border-gray-600 bg-gray-50 dark:bg-gray-700 rounded p-1.5 text-xs" value={form.font_size_header || 20} onChange={e => handleChange('font_size_header', Number(e.target.value))} /></div>
            <div><label className="text-[10px] text-gray-500 block">Greeting Font</label><input type="number" className="w-full border dark:border-gray-600 bg-gray-50 dark:bg-gray-700 rounded p-1.5 text-xs" value={form.font_size_greeting || 14} onChange={e => handleChange('font_size_greeting', Number(e.target.value))} /></div>
            
            <div><label className="text-[10px] text-gray-500 block">Contact Font</label><input type="number" className="w-full border dark:border-gray-600 bg-gray-50 dark:bg-gray-700 rounded p-1.5 text-xs" value={form.font_size_contact || 12} onChange={e => handleChange('font_size_contact', Number(e.target.value))} /></div>
            <div><label className="text-[10px] text-gray-500 block">Body Font</label><input type="number" className="w-full border dark:border-gray-600 bg-gray-50 dark:bg-gray-700 rounded p-1.5 text-xs" value={form.font_size_body || 12} onChange={e => handleChange('font_size_body', Number(e.target.value))} /></div>
            <div><label className="text-[10px] text-gray-500 block">Total Font</label><input type="number" className="w-full border dark:border-gray-600 bg-gray-50 dark:bg-gray-700 rounded p-1.5 text-xs" value={form.font_size_total || 15} onChange={e => handleChange('font_size_total', Number(e.target.value))} /></div>
            
            <div><label className="text-[10px] text-gray-500 block">Footer Font</label><input type="number" className="w-full border dark:border-gray-600 bg-gray-50 dark:bg-gray-700 rounded p-1.5 text-xs" value={form.font_size_footer || 12} onChange={e => handleChange('font_size_footer', Number(e.target.value))} /></div>
            <div><label className="text-[10px] text-gray-500 block">QR Size</label><input type="number" className="w-full border dark:border-gray-600 bg-gray-50 dark:bg-gray-700 rounded p-1.5 text-xs" value={form.qr_size || 80} onChange={e => handleChange('qr_size', Number(e.target.value))} /></div>
            <div><label className="text-[10px] text-gray-500 block">Watermark Font</label><input type="number" className="w-full border dark:border-gray-600 bg-gray-50 dark:bg-gray-700 rounded p-1.5 text-xs" value={form.font_size_watermark || 9} onChange={e => handleChange('font_size_watermark', Number(e.target.value))} /></div>
          </div>

          <h3 className="font-bold text-gray-800 dark:text-white border-b pb-2 pt-2 sticky top-0 bg-white dark:bg-gray-800 z-10">Print Margins (px)</h3>
          <div className="grid grid-cols-4 gap-2">
            <div><label className="text-[10px] text-gray-500 block">Top</label><input type="number" className="w-full border dark:border-gray-600 bg-gray-50 dark:bg-gray-700 rounded p-1 text-xs" value={form.margin_top} onChange={e => handleChange('margin_top', Number(e.target.value))} /></div>
            <div><label className="text-[10px] text-gray-500 block">Bottom</label><input type="number" className="w-full border dark:border-gray-600 bg-gray-50 dark:bg-gray-700 rounded p-1 text-xs" value={form.margin_bottom} onChange={e => handleChange('margin_bottom', Number(e.target.value))} /></div>
            <div><label className="text-[10px] text-gray-500 block">Left</label><input type="number" className="w-full border dark:border-gray-600 bg-gray-50 dark:bg-gray-700 rounded p-1 text-xs" value={form.margin_left} onChange={e => handleChange('margin_left', Number(e.target.value))} /></div>
            <div><label className="text-[10px] text-gray-500 block">Right</label><input type="number" className="w-full border dark:border-gray-600 bg-gray-50 dark:bg-gray-700 rounded p-1 text-xs" value={form.margin_right} onChange={e => handleChange('margin_right', Number(e.target.value))} /></div>
          </div>
        ...
        {/* COLUMN 3: Live Preview (Dynamic based on toggles + Sizes) */}
        <div className="bg-gray-100 dark:bg-gray-900 p-6 rounded-xl shadow-inner border border-gray-300 dark:border-gray-700 flex flex-col items-center overflow-y-auto max-h-[750px] custom-scrollbar">
          ...
          <div 
            className="bg-white text-black font-mono shadow-2xl transition-all duration-200 leading-tight"
            style={{
          ...
          >
            ...
            {form.show_logo && form.logo_url && (
              <div className="flex justify-center mb-2">
                <img src={form.logo_url} alt="Logo" className="object-contain grayscale" style={{ width: `${form.logo_size || 60}px` }} />
              </div>
            )}
            
            {/* 2. Header Block */}
            {form.show_greeting && <div className="text-center font-bold mb-1" style={{ fontSize: `${form.font_size_greeting || 14}px` }}>{form.greeting_text || 'ආයුබෝවන්'}</div>}
            {form.show_header && <div className="text-center font-extrabold mb-1 uppercase" style={{ fontSize: `${form.font_size_header || 20}px` }}>{form.header_text || 'SHOP NAME'}</div>}
            {form.show_contact && <div className="text-center whitespace-pre-wrap mb-2" style={{ fontSize: `${form.font_size_contact || 12}px` }}>{form.contact_info || 'Address\nPhone'}</div>}
            {form.show_tax_no && form.tax_number && <div className="text-center mb-2" style={{ fontSize: `${form.font_size_contact || 12}px` }}>VAT/TAX: {form.tax_number}</div>}
            
            {/* 3. Meta Block */}
            {(form.show_bill_no || form.show_date_time) && (
              <div className="flex justify-between items-end mb-1 mt-2" style={{ fontSize: `${form.font_size_body || 12}px` }}>
                {form.show_bill_no ? <div>Bill {form.bill_number_prefix}1161</div> : <div></div>}
            ...
            {form.show_customer_info && (
              <div className="mb-2 break-words" style={{ fontSize: `${form.font_size_body || 12}px` }}>
            ...
            {form.show_table_headers && (
              <>
                <div className="flex justify-between font-bold mb-1" style={{ fontSize: `${form.font_size_body || 12}px` }}>
                  <div className="w-1/3 text-left">උපරිම<br/>සිල්ලර<br/>මිල</div>
                  <div className="w-1/4 text-right flex items-end justify-end">Rate</div>
            ...
            {/* 6. Items */}
            <div className="space-y-1.5 mt-2" style={{ fontSize: `${form.font_size_body || 12}px` }}>
              <div>
                <div className="truncate mb-0.5">Rollers RVB140...</div>
                <div className="flex justify-between">
                  <span className="w-1/3 text-left">8,500.00</span>
              ...
              <div>
                <div className="truncate mb-0.5">Bearing 6306...</div>
                <div className="flex justify-between">
                  <span className="w-1/3 text-left">525.00</span>
                  <span className="w-1/4 text-right">525.00</span>
            ...
            <div className="border-b border-dashed border-gray-400 my-1.5 mt-2"></div>
            
            {/* 7. Totals & Payment */}
            <div className="space-y-1 mt-1" style={{ fontSize: `${form.font_size_body || 12}px` }}>
              ...
              <div className="flex justify-between items-center font-bold mt-1.5" style={{ fontSize: `${form.font_size_total || 15}px` }}>
                <span>Total Amount</span>
                <span>රු58,885.00</span>
              </div>
              
              {form.show_payment_details && (
                <div className="mt-1.5 space-y-0.5">
                  <div className="flex justify-between"><span>Amount Received</span><span>60,000.00</span></div>
                  <div className="flex justify-between"><span>Payment details</span><span>Cash</span></div>
                </div>
              )}
            </div>
            ...
            {form.show_dynamic_qr && (
              <div className="flex flex-col items-center justify-center my-3">
                <img 
                  ...
                  style={{ width: `${form.qr_size || 80}px`, height: `${form.qr_size || 80}px` }}
                />
                <span className="mt-1 font-semibold" style={{ fontSize: `${(form.font_size_body || 12) - 2}px` }}>Scan for Details</span>
              </div>
            )}

            {/* 9. Footer */}
            {form.show_footer && (
              <div className="text-center font-bold mt-2 whitespace-pre-wrap" style={{ fontSize: `${form.font_size_footer || 12}px` }}>
            ...
            <div className="border-t border-dotted border-black mt-3 pt-2 text-center font-semibold leading-tight" style={{ fontSize: `${form.font_size_watermark || 9}px` }}>
